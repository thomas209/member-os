          ...
          <thead>
            <tr style={{borderBottom:"1px solid #E8E8E8"}}>
              {["Producto","Marca","Categoria","Stock","Precio","Estado"].map((h) => (
                <th key={h} style={{padding:"12px 16px",textAlign:"left",fontSize:"11px",fontWeight:"600",letterSpacing:"0.08em",textTransform:"uppercase",color:"#737373"}}>
                  {h}
                </th>
              ))}
            </tr>
                ...
                <tr key={product.id} style={{borderBottom:"1px solid #F4F4F4"}}>
                  ...
                  <td style={{padding:"16px"}}>
                    <span style={{
                      ...
                      color: totalStock === 0 ? "#DC2626" : totalStock <= 3 ? "#D97706" : "#16A34A",
                    }}>
                      {totalStock} u.
                    </span>
                  </td>
                  ...
                  <td style={{padding:"16px"}}>
                    <span style={{
                      ...
                      color: product.isActive ? "#16A34A" : "#737373",
                      backgroundColor: product.isActive ? "#DCFCE7" : "#F4F4F4",
                      padding:"4px 8px",
                    }}>
