...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // Nota: "/encargos" y "/bigboy" siguen linkeados en el header pero sin
  // ruta implementada en app/ (devuelven 404 en el sitio en vivo) — no se
  // incluyen acá hasta que existan. "/stores" ya tiene página propia.
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/stores`, changeFrequency: "monthly", priority: 0.6 },
  ];
